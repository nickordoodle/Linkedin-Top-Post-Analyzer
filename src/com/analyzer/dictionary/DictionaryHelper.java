package com.analyzer.dictionary;
...
public class DictionaryHelper {
	public static boolean isConjunction(String keyword) {
		all_conjunctions.forEach(String::toLowerCase);
		return all_conjunctions.contains(keyword.toLowerCase());
	}

	public static boolean isPreposition(String keyword) {
		all_prepositions.forEach(String::toLowerCase);
		return all_prepositions.contains(keyword.toLowerCase());
	}

	public static boolean isPronoun(String keyword) {
		all_pronouns.forEach(String::toLowerCase);
		return all_pronouns.contains(keyword.toLowerCase());
	}
